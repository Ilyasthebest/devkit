...
export const ToolCard: React.FC<ToolCardProps> = ({ tool, onOpen }) => {
  return (
    <div
      ...
      className="group relative flex flex-col justify-between p-5 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/80 hover:border-zinc-300 dark:hover:border-zinc-700 shadow-xs hover:shadow-md transition-all duration-200"
    >
